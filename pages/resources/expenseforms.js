...
const forms = [
    { name: 'Petty Cash Voucher',                    document: '../../../../static/reimbursements/PettyCashVoucher.pdf',             icon: 'https://icon.now.sh/attach_money' },
    { name: 'Petty Cash Voucher Template',           document: '../../../../static/reimbursements/PettyCashVoucherTemplate.pdf',     icon: 'https://icon.now.sh/description' },
    { name: 'Entertainment Expense Form',            document: '../../../../static/reimbursements/EntertainmentExpenses.pdf',        icon: 'https://icon.now.sh/attach_money' },
    { name: 'Entertainment Expense Form Template',   document: '../../../../static/reimbursements/EntertainmentExpensesTemplate.pdf', icon: 'https://icon.now.sh/description' },
];

class ExpenseFormsPage extends React.Component {
    constructor(props) {
        super(props);
        this.state = { slide: 0 };
            ...
            <div className='page page-with-staggered-menu'>
                ...
                <div className='reimbursements-page'>
                    ...
                    <Box className='expense-instructions' ml='auto' mr='auto' width={[0.9, 0.7, 0.6, 0.55]}>
                        ...
                        <ol>
                            <li className='instructions-list-item'>Take a picture of your receipts and fill out the <a href='https://docs.google.com/forms/d/e/1FAIpQLScAaMPGQ4CU2LQauBLf7mYsqlTP7tu6zuYGPNX1lAABECF1bA/viewform?usp=header'>McMurtry Expenditure Form</a>, which asks a few basic questions about what your purchase was for. If your purchase was made with a PCard, you're done!</li>
                        ...
                        <ul>
                            ...
                            <li className='instructions-list-item'>You will be texted an access code, which can be used on the padlock right outside of the door on the 5D suite.</li>
                            ...
                            <li className='instructions-list-item'>Once the Mcmurtry Expenditure form is completed, complete the <a href='https://forms.gle/6f7BRW4yiYov3SABA'>PCard Return Form</a> to get another code to return the PCard.</li>
                        </ul>
                    </Box>
                    ...
                    <Flex flexDirection='row' justifyContent='center'>
                        {forms.map((form, i) => (
                            <div
                                ...
                                className={i === this.state.slide ? 'active-form' : 'inactive-form'}
                                key={form.name}
                            >
                    ...
                    <div className='embedded-form'>
                        <iframe src={forms[this.state.slide].document} type='application/pdf' width='600' height='820px' scrollbar='1' toolbar='1' />
                    </div>
