...
// Live value is the 'magisters_fund_form' row in site_links. The other two
// cards below are not college-managed, so they stay hardcoded.
const MAGISTERS_FUND_URL = 'https://docs.google.com/forms/d/e/1FAIpQLSdumVBi5BTTePDHXPLip0LylDZZeB3DGrmSDVUVRWeoXaVdGQ/viewform';

const RESOURCES = [
    {
        href: MAGISTERS_FUND_URL,
        linkKey: 'magisters_fund_form',
...
const FinancialInclusivityPage = () => {
    const links = useSiteLinks({ magisters_fund_form: MAGISTERS_FUND_URL });
                ...
                <section className='fi-resources'>
                    ...
                    <div className='fi-resource-grid'>
                        {RESOURCES.map((resource) => (
                            <a
                                key={resource.href}
                                href={resource.linkKey ? links[resource.linkKey] : resource.href}
