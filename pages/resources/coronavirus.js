...
import content from './coronavirus-content.js';
import './coronavirus.css';

const CoronavirusPage = () => {
    const faqs = content.map((item, i) => (
        <div key={i}>
            <div style={{ textAlign: 'center' }}>
                <p className='covid-question'>{i + 1}. {item.question}</p>
            </div>
            <p className='covid-answer'>{item.answer}</p>
        </div>
    ));
    ...
    return (
        <div className='page page-with-staggered-menu'>
            ...
            <div className='coronavirus-page'>
                ...
                <Box className='covid-subtitle'><p>Quick Links</p></Box>
                ...
                <Box className='covid-subtitle'><p>FAQs</p></Box>
