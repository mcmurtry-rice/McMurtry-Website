...
const OweekGroupsPage = () => (
    <div className='page page-with-staggered-menu'>
        ...
        <div className='oweek-page'>
            ...
            <div id='top-content'>
                {[
                    ['What is an O-Week Group?', whatIsGroupContent],
                    ['What is an Advisor?', whatIsAdvisorContent],
                    ['What is a Co-Advisor?', whatIsCoAdvisorContent],
                    ['What is an Affiliate?', whatIsAffiliateContent],
                ].map(([title, content], i) => (
                    <Box key={title} className='about-text' width={[1, 0.9, 0.8, 0.7]} ml='auto' mr='auto' mb={[10, 10]} mt={i === 0 ? [0, 0] : [20, 50]}>
                ...
                <div className='oweek-groups-links'>
                    {oweekGroups.map(({ name }) => (
                        <Scroll.Link to={name} smooth={true} duration={400} key={name}>
                            <div className='oweek-group-link'>{name}</div>
                        </Scroll.Link>
                    ))}
                </div>
            </div>
...
export default OweekGroupsPage;
