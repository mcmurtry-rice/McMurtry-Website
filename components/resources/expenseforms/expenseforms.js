        ...
        return (
            <div className='reimbursements-page'>
                ...
                <Box className='expense-instructions' ml='auto' mr='auto' width={[0.9, 0.7, 0.6, 0.55]}>
                    ...
                    <ol>
                        <li className='instructions-list-item'>Take a picture of your receipts and fill out the <a href="https://docs.google.com/forms/d/e/1FAIpQLScAaMPGQ4CU2LQauBLf7mYsqlTP7tu6zuYGPNX1lAABECF1bA/viewform?usp=header">
