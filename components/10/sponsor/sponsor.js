...
const Sponsor = () => (
    <div className="sponsor-page">
        ...
        <Box width={[0.8, 0.6]} ml='auto' mr='auto' className='mcm10-message' mt={50}>
            ...
            <p>All donors will have the option to receive 2 tickets to the event. Reach out to <a href="mailto:mcmurtry@rice.edu" target="_blank" rel="noopener noreferrer">mcmurtry@rice.edu</a> if you have any questions</p>
