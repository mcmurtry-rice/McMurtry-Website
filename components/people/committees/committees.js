...
const Committees = () => {
    ...
    // Top-level tabs are derived from distinct `division` values, in
    // source order. Sub-tabs are the committees within the active
    // division.
    ...
    return (
        <div className='committee-page'>
            ...
            {/* Committee chip row (smaller, ghost styled) */}
